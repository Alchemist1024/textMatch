...
def main():
    ...
    # do train
    if args.do_train:
        train_dataset = processor.create_dataset(args.train_max_seq_length, 'train.txt', 'train')
        eval_dataset = processor.create_dataset(args.eval_max_seq_length, 'test.txt', 'dev')
