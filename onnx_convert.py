...
def convert(model_path, to_onnx_path):
    ...
    device = torch.device("cuda:4" if use_gpu else "cpu")
    print(device)
    # print(device)
...
if __name__ == '__main__':
    model_path = 'data/match/save_dict/roberta_fgm_all.pth'
    to_onnx_path = 'data/match/save_dict/roberta_fgm_all_gpu.onnx'
